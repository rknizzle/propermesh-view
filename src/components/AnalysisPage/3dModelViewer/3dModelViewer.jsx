...
const ModelViewer = ({ fileFor3dModel, fileNameFor3dViewer }) => {
  ...
  useEffect(() => {
    if (fileFor3dModel) {
      ...
      setObjectURL(url);
      setFileType(fileNameFor3dViewer.split(".").pop().toLowerCase());
    ...
    // if i add fileNameFor3dViewer in the dependency array, like react wants me to,
